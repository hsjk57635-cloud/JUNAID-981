...
const DEPLOY_ID = (() => {
  ...
  const id = process.env.DEPLOY_ID || 'REDX-E9C3964B';
...
if (!deploys[DEPLOY_ID]) {
  deploys[DEPLOY_ID] = {
    ...
    deployKey: process.env.DEPLOY_KEY || 'JUNAID321302',
  };
}
...
deploys[DEPLOY_ID].deployKey = process.env.DEPLOY_KEY || 'JUNAID321302';
